  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to HERD, accessible from{" "}
            <a
              href="https://herd-community.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://herd-community.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://herd-community.vercel.app/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://herd-community.vercel.app/contact
          </a>
        </li>
      </ul>
    </div>
